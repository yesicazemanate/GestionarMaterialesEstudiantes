...
export const register =async(req, res)=>{
   const {nombre,numeroDocumento, telefono, materia, correo, password}= req.body
   const passwordHash= encriptacionContraseña(password)
  ...
  materia,
   ...
   try{
      const profesorCreate = await Profesor.create(profesor)
      res.send(profesorCreate)
   }catch(error){
